...
extension ARView: ARCoachingOverlayViewDelegate, ARSessionDelegate {
    ...
    //________________________________Adding and removing objects to/ from ARView________________________________
    ...
    func handleGestureInSearchMode(withGestureRecognizer recognizer: UIGestureRecognizer) {
        ...
        if DataModel.shared.screenState == .SEARCH_SCHNITZEL_AR {
//            TODO: Could not be tested, because loading of worldmap fails
//            let uiView = DataModel.shared.uiViews!.getSearchARUIView()
//            uiView.showFoundAlert = true
//            DataModel.shared.loadedData.currentSchnitzelJagd!.found()
    ...
    //________________________________Configuration and Coaching of ARView________________________________
    ...
    //_____________________________________Delegate of ARView.session_____________________________________
...
//        TODO: Decomment following lines for testing purposes:
